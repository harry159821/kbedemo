...
public class FairyGUI_UIPackageWrap
{
	...
	static int AddPackage(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.AssetBundle, bool>(L, 1))
			{
				UnityEngine.AssetBundle arg0 = (UnityEngine.AssetBundle)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.AssetBundle, UnityEngine.AssetBundle, bool>(L, 1))
			{
				UnityEngine.AssetBundle arg0 = (UnityEngine.AssetBundle)ToLua.ToObject(L, 1);
				UnityEngine.AssetBundle arg1 = (UnityEngine.AssetBundle)ToLua.ToObject(L, 2);
			...
			else if (count == 4)
			{
				...
				UnityEngine.AssetBundle arg1 = (UnityEngine.AssetBundle)ToLua.CheckObject(L, 2, typeof(UnityEngine.AssetBundle));
				string arg2 = ToLua.CheckString(L, 3);
				bool arg3 = LuaDLL.luaL_checkboolean(L, 4);
				FairyGUI.UIPackage o = FairyGUI.UIPackage.AddPackage(arg0, arg1, arg2, arg3);
				ToLua.PushObject(L, o);
				return 1;
			}
			else

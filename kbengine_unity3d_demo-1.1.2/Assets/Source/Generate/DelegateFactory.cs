...
public class DelegateFactory
{
	...
	class ResourcesManager_LoadCompleteCallback_Event : LuaDelegate
	{
		public ResourcesManager_LoadCompleteCallback_Event(LuaFunction func) : base(func) { }
		public ResourcesManager_LoadCompleteCallback_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(ResourcesManager.LoadTask param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(ResourcesManager.LoadTask param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public ResourcesManager.LoadCompleteCallback ResourcesManager_LoadCompleteCallback(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			ResourcesManager.LoadCompleteCallback fn = delegate(ResourcesManager.LoadTask param0) { };
			return fn;
		}

		if(!flag)
		{
			ResourcesManager_LoadCompleteCallback_Event target = new ResourcesManager_LoadCompleteCallback_Event(func);
			ResourcesManager.LoadCompleteCallback d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			ResourcesManager_LoadCompleteCallback_Event target = new ResourcesManager_LoadCompleteCallback_Event(func, self);
			ResourcesManager.LoadCompleteCallback d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_ResourcesManager_LoadCompleteCallback(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(ResourcesManager.LoadCompleteCallback), L, pos);
	}

	void Push_ResourcesManager_LoadCompleteCallback(IntPtr L, ResourcesManager.LoadCompleteCallback o)
	{
		ToLua.Push(L, o);
	}
